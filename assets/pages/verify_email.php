...
<div class="login">
    <div class="col-4 bg-white border rounded p-4 shadow-sm">
        <form method="POST" action="assets/php/actions.php?verify_email">
            ...
            <h1 class="h5 mb-3 fw-normal">Verify Your Email Id <br> <small> <?php echo $user['email']; ?> </small></h1>
            ...
            <?php if (isset($_GET['resended'])) {
                echo "<p class='text-success'>Resend Verification code</p>";
            } ?>
            <?= showError('email_verify'); ?>

            <div class="mt-3 d-flex justify-content-between align-items-center">
                <button class="btn btn-primary" type="submit">Verify Email</button>
                <a href="assets/php/actions.php?resend_code" class="btn btn-link text-primary text-decoration-none" type="submit">Resend Code</a>
            </div>
            <br>
