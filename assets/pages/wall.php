    ...
    <div class="container col-9 rounded-0 d-flex justify-content-between">
        <div class="col-8">
            <div class="card mt-4">
                <div class="card-title d-flex justify-content-between  align-items-center">
                    ...
                    <div class="d-flex align-items-center p-2">
                        <img src="assets/images/Post/profile.jpg" alt="" height="30" class="rounded-circle border">&nbsp;&nbsp;Monu
                        Giri
                    </div>
                    <div class="p-2">
                ...
                <img src="assets/images/Post/post2.jpg" class="" alt="...">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/Post/post3.png" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/Post/post4.jpg" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/Post/post.jpg" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
            ...
            <div class="card mt-4">
                ...
                <img src="assets/images/Post/post5.jpg" class="" alt="...">
                <h4 style="font-size: x-larger" class="p-2 border-bottom"><i class="bi bi-heart"></i>&nbsp;&nbsp;<i
                        class="bi bi-chat-left"></i>
                </h4>
                <div class="card-body">
        ...
        <div class="col-4 mt-4 p-3">
            <div class="d-flex align-items-center p-2">
                <div><img src="assets/images/Post/profile.jpg" alt="" height="60" class="rounded-circle border">
                </div>
                <div>&nbsp;&nbsp;&nbsp;</div>
