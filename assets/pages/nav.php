...
<nav class="navbar navbar-expand-lg navbar-light bg-white border">
    <div class="container col-9 d-flex justify-content-between">
        ...
        <ul class="navbar-nav mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="#" data-bs-toggle="modal" data-bs-target="#addpost"><i class="bi bi-plus-square-fill"></i></a>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                    ...
                    <img src="assets/images/Profile/<?php echo $user['profile_pic'] ?>" alt="" style=" height: 30px;width: 30px; object-fit: cover;" class="rounded-circle border">
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="nav-link" href="?edit_profile" style="padding: 0px 15px;">Edit Profile</a>
